...
namespace RTCV.ProcessCorrupt
{
    ...
    public static class NativeTypes
    {
        ...
        [StructLayout(LayoutKind.Sequential)]
        public struct SYSTEM_EXTENDED_THREAD_INFORMATION
        {
            ...
            public IntPtr TebBase; // since VISTA
        ...
        [StructLayout(LayoutKind.Sequential)]
        public struct SYSTEM_EXTENDED_PROCESS_INFORMATION
        {
            public uint NextEntryOffset;
            public uint NumberOfThreads;
            public long SpareLi1;
            ...
            [MarshalAs(UnmanagedType.ByValArray, SizeConst=1)] SYSTEM_EXTENDED_THREAD_INFORMATION[] Threads;
        }
        [StructLayout(LayoutKind.Sequential)]
